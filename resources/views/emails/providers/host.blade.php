                                ...
                                <div style="padding-top:8px;padding-bottom:8px">
                                    <table class="row" style="border-spacing:0;border-collapse:collapse;text-align:left;vertical-align:top;padding:0;width:100%;position:relative;display:table">
                                        <th class="small-12 large-12 columns first" style="font-size:16px;text-align:left;line-height:1.3;font-family:'Circular', Helvetica, Arial, sans-serif;font-weight:normal;padding:0;color:#0a0a0a;padding-right:8px;margin:0 auto;padding-bottom:16px;width:564px;padding-left:16px">
                                            <p class=" body-text-lg light row-pad-bot-1" style='padding:0;margin:0;text-align:left;font-size:24px;font-weight:300;font-family:"Circular", "Helvetica", Helvetica, Arial, sans-serif;color:#484848;word-break:normal;line-height:1.2;padding-bottom:8px !important;margin-bottom:0px !important'>Description</p>
                                            <p class="body-text light" style='margin:0;text-align:left;padding:0;font-weight:300;font-family:"Circular", "Helvetica", Helvetica, Arial, sans-serif;color:#484848;word-break:normal;line-height:1.4;font-size:18px;margin-bottom:0px !important'>{{$data['data']['host_details']['description']}}</p><br>
                                            
                                            <p class="body-text light" style='margin:0;text-align:left;padding:0;font-weight:300;font-family:"Circular", "Helvetica", Helvetica, Arial, sans-serif;color:#484848;word-break:normal;line-height:1.4;font-size:18px;margin-bottom:0px !important'>Updated At: {{common_date($data['data']['host_details']['updated_at'])}}</p>
                                        </th>
                                    </table>
                                </div>
                                <div>
                                ...
                                <div style="padding-top:8px;padding-bottom:8px">
                                    <table class="row" style="border-spacing:0;border-collapse:collapse;text-align:left;vertical-align:top;padding:0;width:100%;position:relative;display:table">
                                        <th class="small-7 large-7 columns first" style="font-size:16px;text-align:left;line-height:1.3;font-family:'Circular', Helvetica, Arial, sans-serif;font-weight:normal;padding:0;color:#0a0a0a;padding-right:8px;margin:0 auto;padding-bottom:16px;width:322.33333px;padding-left:16px">
                                            ...
                                            <p class="body-text light" style='margin:0;text-align:left;padding:0;font-weight:300;font-family:"Circular", "Helvetica", Helvetica, Arial, sans-serif;color:#484848;word-break:normal;line-height:1.4;font-size:18px;margin-bottom:0px !important'>{{formatted_amount($data['data']['host_details']['per_day'])}}</p>
                                        </th>
                                    </table>
                                </div>
                                    ...
                                    <table class="row" style="border-spacing:0;border-collapse:collapse;text-align:left;vertical-align:top;padding:0;width:100%;position:relative;display:table">
                                        <tr style="padding:0;vertical-align:top;text-align:left">
                                            <th class="col-pad-left-2 col-pad-right-2" style="color:#0a0a0a;font-family:'Circular', Helvetica, Arial, sans-serif;font-weight:normal;padding:0;margin:0;text-align:left;font-size:16px;line-height:1.3;padding-left:226px;padding-right:226px">
                                                ...
                                                <a href="{{ $data['data']['url'] }}" style="font-family:'Circular', Helvetica, Arial, sans-serif;font-weight:normal;margin:0;text-align:left;line-height:1.3;color:#2199e8;text-decoration:none;background-color:#ff5a5f;-webkit-border-radius:3px;border-radius:4px;padding:19px 24px 19px 24px;display:block">
