                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="name">{{ tr('user_display_name') }} <span class="admin-required">*</span></label>
                            ...
                            <div class="form-group col-md-6">
                                <label for="provider_name">{{ tr('provider_display_name') }} <span class="admin-required">*</span></label>
                                <input type="text" class="form-control" id="provider_name" name="provider_name" placeholder="{{ tr('provider_name') }}" value="{{ old('provider_name') ?: $sub_category_details->provider_name}}" required>
                            </div>
