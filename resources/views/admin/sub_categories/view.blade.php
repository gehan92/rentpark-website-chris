        ...
        <div class="col-md-12">
            ...
            <div class="card-group">
                ...
                <div class="card mb-4">
                    ...
                    <!-- Card content -->
                    <div class="card-body">
                        @if($sub_category_details->description)
                            <!-- Title -->
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="custom-card">
                            ...
                            <h5 class="card-title">{{tr('sub_category_user_name')}}</h5>
                        ...
                        <div class="custom-card">
                            ...
                            <h5 class="card-title">{{tr('sub_category_provider_name')}}</h5>
                            
                            <p class="card-text">{{ $sub_category_details->provider_name }}</p>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-success btn-block" href="{{ route('admin.spaces.index', ['sub_category_id'=>$sub_category_details->id]) }}"> 
                        {{tr('hosts')}}
                        </a>   
