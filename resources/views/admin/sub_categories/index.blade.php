            ...
            <div class="card-header bg-card-header ">
                ...
                <h4 class="">
                    ...
                    @if($category_details)
                        ...
                        <a class="custom-a" href="{{route('admin.categories.view', $category_details->id)}}">
                                    ...
                                    <div class="template-demo">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuOutlineButton1">
                                                ...
                                                <a class="dropdown-item" href="{{route('admin.spaces.index', ['sub_category_id' => $sub_category_details->id])}}">{{tr('hosts')}}</a>

                                                <a class="dropdown-item"  href="{{route('admin.bookings.index', ['sub_category_id' => $sub_category_details->id])}}">{{tr('bookings')}}</a>

                                                <a class="dropdown-item" href="{{ route('admin.questions.module.index', ['module' => SUB_CATEGORIES, 'sub_category_id'=> $sub_category_details->id] ) }}">{{tr('questions')}}
                                                </a>
