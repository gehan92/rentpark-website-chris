        ...
        <div class="col-md-12">
            ...
            <div class="card-group">
                ...
                <div class="card mb-4">
                    ...
                    <!-- Card content -->
                    <div class="card-body">
                        @if($category_details->description)
                            <!-- Title -->
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="custom-card">
                            ...
                            <h5 class="card-title">{{tr('category_user_name')}}</h5>
                        ...
                        <div class="custom-card">
                            ...
                            <h5 class="card-title">{{tr('category_provider_name')}}</h5>
                            
                            <p class="card-text">{{ $category_details->provider_name }}</p>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-success btn-block" href="{{ route('admin.spaces.index', ['category_id'=>$category_details->id]) }}"> 
