                        ...
                        <tbody>
                            ...
                            @foreach($categories as $i => $category_details)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{$category_details->provider_name}}
                                    </td>
                                    ...
                                    <td>                                                                        
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuOutlineButton1">
                                                ...
                                                <a class="dropdown-item" href="{{route('admin.spaces.index', ['category_id' => $category_details->id])}}">{{tr('hosts')}}</a>

                                                <a class="dropdown-item"  href="{{route('admin.bookings.index', ['category_id' => $category_details->id])}}">{{tr('bookings')}}</a>

                                                <a class="dropdown-item" href="{{ route('admin.questions.module.index', ['module' => CATEGORIES, 'category_id'=>$category_details->id] ) }}">{{tr('questions')}}
                                                </a>
