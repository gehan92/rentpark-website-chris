                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="provider_name" name="provider_name" placeholder="{{ tr('provider_name') }}" value="{{ old('provider_name') ?: $category_details->provider_name }}" required>
