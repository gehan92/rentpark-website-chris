                            ...
                            <table class="table mb-0">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pr-0 text-right"><div>{{ common_date($user_details->created_at) }}</div></td>
                                </tr>

                                <tr>
                                    <td class="pl-0"> <b>{{ tr('updated_at') }}</b></td>
                                    <td class="pr-0 text-right"><div>{{ common_date($user_details->updated_at) }}</div></td>
                                </tr>
                            ...
                            <table class="table mb-0">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pr-0  text-right">
                                        <div> {{ $user_billing_info->account_name ?? '' }} </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="pr-0  text-right">
                                        <div>{{ $user_billing_info->account_no ?? ''}} </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="pr-0  text-right">
                                        <div>{{ $user_billing_info->paypal_email ?? '' }} </div>
                                    </td>
                                </tr>

                                <tr>
                                    <td class="pl-0"> <b> {{ tr('route_no')}} </b> </td>
                                    <td class="pr-0  text-right">
                                        <div>{{ $user_billing_info->route_no ?? '' }} </div>
                                    </td>
                                </tr>
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h4 class="">{{tr('vehicle_details')}}
                        ...
                        <a class="btn btn-success pull-right" href="{{ route('admin.vehicle_details.create', ['user_id' => $user_details->id]) }}"> {{tr('add_vehicle')}}
                        </a>
