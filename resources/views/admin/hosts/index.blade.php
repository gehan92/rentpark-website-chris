                    	...
                    	@foreach($hosts as $h => $host_details)
	                    	...
	                    	<tr>
	                    		...
	                    		<td>
	                    			...
	                    			<p class="text-gray"><br>{{common_date($host_details->updated_at, Auth::guard('admin')->user()->timezone, 'd M Y H:i A')}}</p>
                                        
                                    <p class="{{hosts_step_color($host_details->complete_percentage)}}">{{$host_details->complete_percentage}} % Completed</p>
                                ...
                                <td>
                                    ...
                                    @else
                                        ...
                                        <a class="badge badge-info" href="{{ route('admin.hosts.verification_status', ['host_id' => $host_details->id]) }}"> 
                                            {{ tr('verify') }} 
                                        </a>
                                    ...
                                    <div class="template-demo">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuOutlineButton1">
                                                ...
                                                <a class="dropdown-item" href="{{ route('admin.hosts.availability_view', ['id' => $host_details->id]) }}">
                                                    {{tr('availability')}}
                                                </a>

                                                <a class="dropdown-item" href="{{ route('admin.hosts.gallery.index', ['host_id' => $host_details->id] ) }}">
                                                        {{tr('gallery')}}
                                                </a>

                                                <a class="dropdown-item" href="{{ route('admin.hosts.amenities.index', ['host_id' => $host_details->id] ) }}">
                                                        {{tr('amenities')}}
                                                </a>

                                                <a class="dropdown-item" href="{{ route('admin.hosts.reviews.index', ['host_id' => $host_details->id] ) }}">
                                                        {{tr('reviews')}}
                                                </a>
