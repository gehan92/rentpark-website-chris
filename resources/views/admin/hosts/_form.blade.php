                    ...
                    <div>
                        ...
                        <section>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <label>{{tr('access_note')}} *</label>

                                    <div class="switch-field">

                                        <select class="form-control select2" id="bathroom_type" name="bathroom_type">
                        ...
                        <section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <h5 class="text-uppercase">{{tr('booking_preference')}}</h5>
                                    <hr>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for="check_in">{{tr('check_in')}}</label>

                                        <select class="form-control" id="check_in" name="check_in">

                                            <option value="">{{tr('check_in_time')}}</option>

                                            @foreach($check_ins as $check_in)
                                                <option value="{{$check_in['value']}}" @if($check_in['is_selected'] == YES) selected @endif>{{$check_in['value']}}</option>
                                            @endforeach
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for="check_out">{{tr('check_out')}}</label>

                                        <select class="form-control" id="check_out" name="check_out">

                                            <option value="">{{tr('check_out_time')}}</option>
                                            @foreach($check_outs as $check_out)
                                                <option value="{{$check_out['value']}}" @if($check_out['is_selected'] == YES) selected @endif>{{$check_out['value']}}</option>
                                            @endforeach
