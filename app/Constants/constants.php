...
if(!defined('BELL_NOTIFICATION_TYPE_HOST_APPROVED')) define('BELL_NOTIFICATION_TYPE_HOST_APPROVED' , 10);

if(!defined('BELL_NOTIFICATION_TYPE_HOST_DECLINED')) define('BELL_NOTIFICATION_TYPE_HOST_DECLINED' , 11);
...
if(!defined('HOST_STEP_WEB')) define('HOST_STEP_WEB', 'WEB');
...
if(!defined('PUSH_NOTIFICATION_REDIRECT_HOST_VIEW')) define('PUSH_NOTIFICATION_REDIRECT_HOST_VIEW', 2);
...
if (!defined('HOST_TYPE_DRIVEWAY')) define('HOST_TYPE_DRIVEWAY', 'driveway');

if (!defined('HOST_TYPE_GARAGE')) define('HOST_TYPE_GARAGE', 'garage');

if (!defined('HOST_TYPE_CAR_PARK')) define('HOST_TYPE_CAR_PARK', 'carpark');


if (!defined('HOST_AVAIL_ADD_SPACE')) define('HOST_AVAIL_ADD_SPACE', 1);

if (!defined('HOST_AVAIL_REMOVE_SPACE')) define('HOST_AVAIL_REMOVE_SPACE', 0);
